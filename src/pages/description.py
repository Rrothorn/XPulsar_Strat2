...
card_bg_img = 'linear-gradient(to right, rgba(0,0,0,1), rgba(4,104,125,0.9))'
card_bg_img2 = 'linear-gradient(to right, rgba(0,0,0,1), rgba(4,104,125,1))'
        ...
        dbc.Row([
            dbc.Col([
                 create_titled_card('Description',
                                    html.P("The algorithm presented herein represents a sophisticated, data-driven investment fund leveraging advanced AI and Machine Learning algorithms. This fund operates within the realm of US Index Futures, predicting the expansion of the daily range. The algorithm strategically engages both long and short positions to capitalise on market opportunities. The trade execution is fully automated to avoid human error and emotion.", 
                                                    className='card-text', 
                                                    style={'color':'#95D7E0'},
                                                    ),
